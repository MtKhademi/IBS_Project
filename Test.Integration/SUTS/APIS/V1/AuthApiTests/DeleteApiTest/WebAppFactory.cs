...
public partial class WebAppFactoryForDelete : WebApplicationFactory<Api.Program>,
    IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        using (var scope = Services.CreateScope())
        {
            ...
            await DeleteApiTestRequierAsync(repository);
...
[CollectionDefinition("Collection tests V1-ForDelete")]
public class DatabaseCollectionForDelete : ICollectionFixture<WebAppFactoryForDelete>
{
}
