...
[Trait("Api.V1.Question.SUS", nameof(QuestionAddWithExcellFileApiTest))]
    ...
    IClassFixture<WebAppFactory>
{
    ...
    private string _apiAddress = "/api/V1/QuestionApi/SUS/AddWithExcellFile";
    ...
    public async Task Step1_When_not_valid_data_Expect_get_bad_response()
    {
        ...
        var questions = await _factory.Repositories.QuestionGetsAsync(ETypeOfQuestion.SUS);
