...
namespace Test.Integration.SUTS.APIS.V1.QuestionApiTests.QualityLifeQuestionAddWithExcellFileApiTest;



[Collection("Collection tests V1")]
[Trait("Api.V1.Question.QUALITY", nameof(QuestionAddWithExcellFileApiTest))]
    ...
    IClassFixture<WebAppFactory>
{
    ...
    private string _apiAddress = "/api/V1/QuestionApi/Quality/AddWithExcellFile";
    ...
    public async Task Step1_When_not_valid_data_Expect_get_bad_response()
    {
        ...
        var pathFile = Path.Combine(
            ...
            nameof(QualityLifeQuestionAddWithExcellFileApiTest),
            "exc.xlsx");
        ...
        var questions = await _factory.Repositories.QuestionGetsAsync(ETypeOfQuestion.QualityOfLife);
